...
# p <- ggplot(data=plotdf, aes(x=agedays, y=fit, group=interaction(cohort, born_wast), color=born_wast,  fill=born_wast)) +
#   geom_line(size=1, data=plotdf_strat, alpha=0.5, color="grey70") +
