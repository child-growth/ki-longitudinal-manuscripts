...
gdp_data <- readRDS(paste0(BV_dir,"/results/wasting_desc_data_country.RDS")) %>% 
  mutate(country_cat = factor(country_cat, levels = c(
    "Overall", "Low income", "Middle income"
  )))

gdi_data <- readRDS(paste0(BV_dir,"/results/wasting_desc_data_country.RDS")) %>% 
...
gii_data <- readRDS(paste0(BV_dir,"/results/wasting_desc_data_country.RDS")) %>% 
  mutate(country_cat = case_when(
    country_cat == "Overall" ~ "Overall",
...
chi_data <- readRDS(paste0(BV_dir,"/results/wasting_desc_data_country.RDS")) %>% 
  mutate(country_cat = factor(country_cat, levels = c(
    "Overall", "Low", "Medium", "High"
  )))

gini_data <- readRDS(paste0(BV_dir,"/results/wasting_desc_data_country.RDS")) %>% 
  mutate(country_cat = factor(country_cat, levels = c(
    "Overall", "Low", "Medium", "High"
  )))

he_data <- readRDS(paste0(BV_dir,"/results/wasting_desc_data_country.RDS")) %>% 
  mutate(country_cat = case_when(
    country_cat == "Overall" ~ "Overall",
    country_cat == "Low" ~ "1-3%",
...
pov_data <- readRDS(paste0(BV_dir,"/results/wasting_desc_data_country.RDS")) %>% 
  mutate(country_cat = case_when(
    country_cat == "Overall" ~ "Overall",
...
birthlaz_data <- readRDS(paste0(BV_dir,"/results/wasting_desc_data_country.RDS")) %>% 
  mutate(country_cat = factor(country_cat, levels = c(
    "Overall", "[-6,-2]", "(-2,-1]", 
    "(-1,0]", "0,6"
  )))

mort_data <- readRDS(paste0(BV_dir,"/results/wasting_desc_data_country.RDS"))  %>% 
  mutate(country_cat = factor(country_cat, levels = c(
