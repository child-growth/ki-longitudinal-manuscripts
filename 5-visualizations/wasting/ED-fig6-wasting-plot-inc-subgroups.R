...
ggsave(plot = ip_plot_primary_he$plot, width=14,height=5,
       filename=paste0(here::here(),"/figures/ED-pngs/wasting/ED-fig6a.jpeg"), device='jpeg')
ggsave(plot = ip_plot_primary_pov$plot, width=14,height=5,
       filename=paste0(here::here(),"/figures/ED-pngs/wasting/ED-fig6b.jpeg"), device='jpeg')
ggsave(plot = ip_plot_primary_mort$plot, width=14,height=5,
