...
quantiles <- readRDS(paste0(BV_dir,"/results/quantile_data_underweight.RDS"))

d <- d %>% filter(disease=="Underweight")
...
d <- d %>% mutate(pooling=ifelse(cohort=="pooled" & is.na(pooling),region,pooling)) %>%
  filter(analysis=="Underweight", (pooling!="country" | is.na(pooling)))
...
ggsave(mean_wlz_plot, file=paste0(BV_dir,"/figures/underweight/fig-",mean_wlz_plot_name,".png"), width=14, height=3)
saveRDS(df, file=paste0(figdata_dir_underweight,"figdata-",mean_wlz_plot_name,".RDS"))
...
# save plot and underlying data
ggsave(prev_plot[[1]], file=paste0(BV_dir,"/figures/underweight/fig-",prev_plot_name, ".png"), width=14, height=3)
ggsave(prev_plot_africa$plot, file=paste0(BV_dir,"/figures/underweight/fig-","prev_plot_africa", ".png"), width=10, height=5)
ggsave(prev_plot_lam$plot, file=paste0(BV_dir,"/figures/underweight/fig-","prev_plot_lam", ".png"), width=15, height=5)
ggsave(prev_plot_sasia$plot, file=paste0(BV_dir,"/figures/underweight/fig-","prev_plot_sasia", ".png"), width=18, height=10)

saveRDS(prev_plot[[2]], file=paste0(figdata_dir_underweight,"figdata-",prev_plot_name,".RDS"))
...
#ggsave(prev_plot[[1]] + ggtitle("underweight prevalence"), file=paste0(BV_dir,"/figures/underweight/fig-",prev_plot_name, "_presentation.png"), width=13, height=3)
...
# save plot and underlying data
ggsave(ip_plot_primary[[1]], file=paste0(BV_dir,"/figures/underweight/fig-",ip_plot_name, ".png"), width=14, height=3)

saveRDS(ip_plot_primary[[2]], file=paste0(figdata_dir_underweight,"figdata-",ip_plot_name,".RDS"))
...
#-------------------------------------------------------------------------------------------
# underweight incidence -birthstrat
#-------------------------------------------------------------------------------------------
...
# save plot and underlying data
ggsave(ip_plot[[1]], file=paste0(BV_dir,"/figures/underweight/fig-",ip_plot_name, "_birthstrat.png"), width=14, height=3)

saveRDS(ip_plot[[2]], file=paste0(figdata_dir_underweight,"figdata-",ip_plot_name,"_birthstrat.RDS"))

#ggsave(ci_plot[[1]] + ggtitle("underweight incidence"), file=paste0(BV_dir,"/figures/underweight/fig-",ci_plot_name, "_birthstrat_presentation.png"), width=13, height=3)



#-------------------------------------------------------------------------------------------
# underweight incidence rate
#-------------------------------------------------------------------------------------------
...
inc_combo_plot <- function(d, Disease, Measure, Birth, Severe, Age_range, 
  ...
  p <- ggplot(df,aes(y=est,x=agecat)) +
    ...
    scale_shape_manual(values = c(16, 17),
                       name = 'Measure', 
                       labels = c('Including underweight at birth', 'Excluding underweight at birth')) + 
...
# save plot and underlying data
ggsave(inc_plot_primary$plot, file=paste0(BV_dir,"/figures/underweight/fig-",inc_plot_name, ".png"), width=14, height=3)

saveRDS(inc_plot_primary$data, file=paste0(figdata_dir_underweight,"figdata-",inc_plot_name,".RDS"))
...
rec_combo_plot <- function(d, Disease, Measure, Birth, Severe, Age_range, 
                           # Cohort="pooled",
                           xlabel="Age at underweight episode onset",
                           ylabel="",
                           yrange=c(0,90),
                           legend.pos = c(.9,.32),
                           facet=T){
...
# save plot and underlying data
ggsave(rec_plot[[1]], file=paste0(BV_dir,"/figures/underweight/fig-",rec_plot_name, ".png"), width=14, height=4.5)
saveRDS(rec_plot[[2]], file=paste0(figdata_dir_underweight,"figdata-",rec_plot_name,".RDS"))
...
p <- ggplot(df,aes(y=est,x=agecat)) +
  ...
  ggtitle('Recovery within 30, 60, or 90 days of underweight onset') +
  scale_y_continuous(breaks = scales::pretty_breaks(n = 10)) +
  theme(strip.text = element_text(size=22, margin = margin(t = 5))) +
...
# save plot and underlying data
ggsave(p, file=paste0(BV_dir,"/figures/underweight/fig-",rec_plot_name, ".png"), width=8, height=5)

saveRDS(df, file=paste0(figdata_dir_underweight,"figdata-",rec_plot_name,".RDS"))
...
perswast_plot <- ki_desc_flurry_plot(d,
                                     Disease="Underweight",
                                     Measure="Persistent underweight", 
                                     Birth="yes", 
                                     Severe="no", 
                                     Age_range="6 months", 
                                     xlabel="Child age, months",
...
ggsave(perswast_plot_sasia$plot, file=paste0(BV_dir,"/figures/underweight/fig-","perswast_plot_sasia", ".png"), width=15, height=8)

saveRDS(perswast_plot[[2]], file=paste0(figdata_dir_underweight,"figdata-",perswast_plot_name,".RDS"))
...
# save plot and underlying data
ggsave(sevwast_plot[[1]], file=paste0(BV_dir,"/figures/underweight/fig-",sevwast_plot_name, ".png"), width=14, height=3)
ggsave(sevwast_plot_africa$plot, file=paste0(BV_dir,"/figures/underweight/fig-","sevwast_plot_africa", ".png"), width=10, height=5)
ggsave(sevwast_plot_lam$plot, file=paste0(BV_dir,"/figures/underweight/fig-","sevwast_plot_lam", ".png"), width=15, height=5)
ggsave(sevwast_plot_sasia$plot, file=paste0(BV_dir,"/figures/underweight/fig-","sevwast_plot_sasia", ".png"), width=18, height=8)


saveRDS(sevwast_plot[[2]], file=paste0(figdata_dir_underweight,"figdata-",sevwast_plot_name,".RDS"))
