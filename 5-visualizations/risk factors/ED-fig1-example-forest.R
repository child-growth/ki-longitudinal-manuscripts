...
#Save jpeg for nature
p2 <- p + theme(legend.position=c(0.8, 0.3)) + guides(color="legend", shape="none") 

ggsave(plot = p2, width=14, height=10,
       filename=paste0(here::here(),"/figures/ED-pngs/C+C/ED-fig1.jpeg"), device='jpeg')
