...
ggsave(p_grid, file=paste0(here(),"/figures/risk factor/spline_grid_sens.png"), width=14, height=14)


#Save plot objects
save(p1, p2, p3, p4, p5, p6,  file=paste0(here(),"/results/rf_spline_sens_objects.Rdata"))
