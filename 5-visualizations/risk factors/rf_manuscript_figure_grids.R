...
#Twoby1plotB_t <- plot_grid(titleB, Twoby1plotB, ncol=1, rel_heights=c(0.1, 1.5))
...
#ggsave(fig3, file=paste0(BV_dir,"/figures/manuscript-figure-composites/risk-factor/fig3.png"), width=18.3, height=19.6, units = 'cm')
