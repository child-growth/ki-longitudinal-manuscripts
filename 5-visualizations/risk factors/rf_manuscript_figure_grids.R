...
ggsave(plot = fig3, filename=paste0(here::here(),"/figures/manuscript-pdfs/c&c/Fig4.pdf"), device='pdf', width=14, height=14)
...
ggsave(plot = fig4, filename=paste0(here::here(),"/figures/manuscript-pdfs/c&c/Fig5.pdf"), device='pdf', width=18.3/1.25, height=9/1.25)
