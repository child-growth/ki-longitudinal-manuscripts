...
plotdf$agecat[plotdf$agecat=="0-6 months (no birth wast)"] <- "0-6 months"
...
ggsave(p, file=paste0("C:/Users/andre/Documents/HBGDki/ki-longitudinal-manuscripts/figures/risk factor/fig-age-strat-wast.png"), height=8, width=10)
