...
variable_labels = c(
  "51% shifted to Female sex" = "51% shifted to Female", "67% shifted to >=50 birthlen" =
    ...
    "48% shifted to [0%,2%]", "70% shifted to Yes earlybf" = "70% shifted to Yes", "75% shifted to Opposite max rain rain_quartile" =
    "75% shifted to Opposite max rain", "Male sex" = "Male", "Female sex" =
    "Female", "<48 birthlen" = "<48", ">=50 birthlen" = "≥50", "[48-50) birthlen" =
    "[48-50)", "< 2500 g birthwt" = "< 2500 g", "<2500g birthwt" = "<2500g", "Preterm gagebrth" =
    "Preterm", "Full/late term gagebrth" = "Full/late term", "Early term gagebrth" =
    ...
    "Medium", "No predexfd6" = "No", "Yes predexfd6" = "Yes", ">2% perdiar24" =
    ">2%", "[0%,2%] perdiar24" = "[0%,2%]", "No earlybf" = "No", "Yes earlybf" =
    "Yes", "Opposite max rain rain_quartile" = "Opposite max rain", "Post-max rain rain_quartile" =
    "Post-max rain", "Pre-max rain rain_quartile" = "Pre-max rain", "Max rain rain_quartile" =
    "Max rain", "51% shifted to Female sex" = "51% shifted to Female", "67% shifted to >=50 birthlen" =
    ...
    "Medium", "Low feducyrs" = "Low", "High feducyrs" = "High", "Medium feducyrs" =
    "Medium", "No predexfd6" = "No", "Yes predexfd6" = "Yes", ">2% perdiar24" =
    ">2%", "[0%,2%] perdiar24" = "[0%,2%]", "Opposite max rain rain_quartile" =
    "Opposite max rain", "Pre-max rain rain_quartile" = "Pre-max rain", "Max rain rain_quartile" =
    "Max rain", "Post-max rain rain_quartile" = "Post-max rain", "No earlybf" =
    "No", "Yes earlybf" = "Yes" )
...
# plot function
#----------------------------------------------------------
d=df %>% filter(intervention_variable=="birthlen"|intervention_variable=="birthwt")
ylimits=c(-0.1, 0.8)
outcome_var="haz"
...
#XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
  ...
  p2 <- plot_combined_pie_ate(df[df$RFgroup=="Postnatal child characteristics",], facet_label_pos= -55)
  p3 <- plot_combined_pie_ate(df[df$RFgroup=="Parental Characteristics",], facet_label_pos= -7)
