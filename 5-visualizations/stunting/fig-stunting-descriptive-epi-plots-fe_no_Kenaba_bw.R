...
# outputs: 
# fig-stunt-2-prev-overall_region--allage-fe_no_Kenaba_bw.png
# fig-stunt-3-prev-overall_region--allage-fe_no_Kenaba_bw.png
# fig-stunt-2-inc-overall_region--allage-fe_no_Kenaba_bw.png
# fig-stunt-3-inc-overall_region--allage-fe_no_Kenaba_bw.png

# figdata-stunt-2-prev-overall_region--allage-fe_no_Kenaba_bw.RDS
# figdata-stunt-3-prev-overall_region--allage-fe_no_Kenaba_bw.RDS
# figdata-stunt-2-inc-overall_region--allage-fe_no_Kenaba_bw.RDS
# figdata-stunt-3-inc-overall_region--allage-fe_no_Kenaba_bw.RDS
...
d <- d %>% filter(analysis == "No Kenaba - Fixed effects")
