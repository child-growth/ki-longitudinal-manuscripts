...
# Andrew to confirm whether
# nih birth cohort bangladesh,
# probit, and provide are to be included
...
save(prev, sev.prev,  haz,  monthly.haz, rev, ci, ci_3,   sev.ci, 
     file = "U:/ki-longitudinal-manuscripts/results/stunting/shiny_desc_data_stunting_objects_monthly24.Rdata")
