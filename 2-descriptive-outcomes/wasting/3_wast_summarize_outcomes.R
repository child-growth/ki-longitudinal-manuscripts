...
wasting_desc_data <- bind_rows(
  ...
  data.frame(disease = "Wasting", age_range="6 months",   birth="no",  severe="no",   measure= "Cumulative incidence without birth episodes",  ci_nobw),
  data.frame(disease = "Wasting", age_range="3 months",   birth="no",  severe="no",   measure= "Cumulative incidence without birth episodes",  ci_nobw3),
