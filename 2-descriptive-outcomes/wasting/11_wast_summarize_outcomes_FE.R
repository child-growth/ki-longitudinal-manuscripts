...
ci.data3 <- summary.ci(d3, age.range=3, method="FE")
ci.region3 <- d3 %>% group_by(region) %>% do(summary.ci(., age.range=3, method="FE")$ci.res)
ci.country3 <- d3 %>% group_by(region, country) %>% do(summary.ci(., age.range=3, method="FE")$ci.res) 
ci.cohort3 <-
...
ci.data.nobirth <- summary.ci(d_noBW, age.range=6, method="FE")
ci.region.nobirth <- d %>% group_by(region) %>% do(summary.ci(., age.range=6, method="FE")$ci.res)
ci.country.nobirth <- d %>% group_by(region, country) %>% do(summary.ci(., age.range=6, method="FE")$ci.res) 
ci.cohort.nobirth <-
...
ci.data.nobirth3 <- summary.ci(d3, age.range=3, method="FE")
ci.region.nobirth3 <- d3 %>% group_by(region) %>% do(summary.ci(., age.range=3, method="FE")$ci.res)
ci.country.nobirth3 <- d3 %>% group_by(region, country) %>% do(summary.ci(., age.range=3, method="FE")$ci.res) 
ci.cohort.nobirth3 <-
...
sev.ci.data <- summary.ci(d=d,  severe.wasted = T, age.range=6, method="FE")
sev.ci.region <- d %>% group_by(region) %>% do(summary.ci(., severe.wasted = T, age.range=6, method="FE")$ci.res)
sev.ci.country <- d %>% group_by(region, country) %>% do(summary.ci(., severe.wasted = T, age.range=6, method="FE")$ci.res) 
sev.ci.cohort <-
