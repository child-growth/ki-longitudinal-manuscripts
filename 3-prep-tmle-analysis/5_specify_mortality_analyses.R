...
mortality <- specify_rf_analysis(A=Avars, Y=c("dead", "dead624"), 
...
save(analyses, file="U:/sprint_7D_longbow/Manuscript analysis/mortality_analyses.rdata")
...
save(analyses, file="U:/sprint_7D_longbow/Manuscript analysis/unadjusted_mortality_analyses.rdata")
