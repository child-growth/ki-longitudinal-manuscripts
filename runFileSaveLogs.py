...
parser.add_argument("-l", "--logDirPrefix", help="The directory in which log files will be saved to.", default="/logs/", type=lambda logDirPrefix: is_valid_directory(parser, logDirPrefix))
