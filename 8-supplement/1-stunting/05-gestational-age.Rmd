...
```{r ga-cohort, echo = FALSE}
#include_graphics(paste0(here::here(), "/figures/shared/fig-GA-by-cohort-histogram.png"))
include_graphics("figure-copies/fig-GA-by-cohort-histogram.png")
```
