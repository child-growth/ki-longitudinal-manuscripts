...
#Merge in wealth
cont_wealth <- cont_wealth %>% filter(outcome_variable %in% unique(cont_wealth$outcome_variable))
...
bin_primary <- readRDS(here("results/rf results/raw longbow results/results_bin_primary_2021-04-22.RDS"))
...
Zscores_unadj <- readRDS(here("results/rf results/raw longbow results/results_cont_unadj_2021-04-19.rds"))
