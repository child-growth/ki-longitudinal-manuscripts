...
writeLines(toJSON(enumerated_analyses),"seasonality_analyses.json")
...
filename1 <- paste(paste('seasonality_results',Sys.Date( ),sep='_'),'rdata',sep='.')
filename2 <- paste(paste('seasonality_results_obs_counts',Sys.Date( ),sep='_'),'rdata',sep='.')
