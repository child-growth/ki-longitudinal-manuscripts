...
writeLines(toJSON(enumerated_analyses),"seasonality_rf_bin_analyses.json")
...
filename1 <- paste(paste('seasonality_rf_bin_results',Sys.Date( ),sep='_'),'rdata',sep='.')
filename2 <- paste(paste('seasonality_rf_bin_results_obs_counts',Sys.Date( ),sep='_'),'rdata',sep='.')
