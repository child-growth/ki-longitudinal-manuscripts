...
# levels(d$perdiar24)
# save(d, file="/data/KI/UCB-SuperLearner/Manuscript analysis data/st_meanZ_optx_test.Rdata")
# enumerated_analyses[[26]]$data$uri <-  "/data/KI/UCB-SuperLearner/Manuscript analysis data/st_meanZ_optx_test.Rdata"

writeLines(jsonlite::toJSON(enumerated_analyses[[26]]),"single_analysis.json")
...
rmd_filename <- here("4-longbow-tmle-analysis/run-longbow/longbow_OptTX_test.Rmd")
...
get_batch_results(batch_id, results_folder="results_optx_test")
length(dir("results_optx_test"))
...
filename1 <- paste(paste('opttx_vim_results_test',Sys.Date( ),sep='_'),'RDS',sep='.')
filename2 <- paste(paste('opttx_vim_obs_counts_test',Sys.Date( ),sep='_'),'RDS',sep='.')
