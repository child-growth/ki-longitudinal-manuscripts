...
co_occurence_data_path              = paste0(ghapdata_dir, "co_occurrence_data.rds")
...
metadata-GHAP_metadata_wasting_path = paste0(metadata_dir, "GHAP_metadata_wasting.RDS")
results-GHAP_metadata_wasting_path  = paste0(res_dir, "GHAP_metadata_wasting.RDS")
metadata-GHAP_metadata_stunting_path = paste0(metadata_dir, "GHAP_metadata_stunting.RDS")
results-GHAP_metadata_stunting_path  = paste0(res_dir, "GHAP_metadata_stunting.RDS")
metadata-GHAP_metadata_stunting_xlsx_path = paste0(metadata_dir, "GHAP_metadata_stunting.xlsx")
