...
#TO DO
#Just pool by decade and birth measure
#Pool by -3, -2, -1 groupings at birth
#Make as seperate DF from the regional groupings
#Make a table-1 of the others grouped by region
...
# df$gini_cat <- cut(df$gini, breaks=c(-9999999,  30,35,40,45,50, 9999999), 
