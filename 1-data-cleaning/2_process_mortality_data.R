...
mort <- mort %>% filter(!(studyid %in% c("ki1000301-DIVIDS", "ki1000304-ZnMort", "ki1055867-WomenFirst")))

saveRDS(mort, file="U:/UCB-SuperLearner/Manuscript analysis data/mortality.rds")
